...
DEBUG_CMDLINE = "dwc_otg.lpm_enable=0 console=tty1 console=serial0,115200 root=LABEL=resin-rootA rootdelay=5 fsck.repair=yes rootfstype=ext4 rootwait"
PRODUCTION_CMDLINE = "dwc_otg.lpm_enable=0 console=null root=LABEL=resin-rootA rootdelay=5 fsck.repair=yes rootfstype=ext4 rootwait vt.global_cursor_default=0"
