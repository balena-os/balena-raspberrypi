...
RPIFW_DATE = "20250127"
SRCREV = "39a2813a75827b3a4d104a97e8f872df5d4f7e54"
SHORTREV = "${@d.getVar("SRCREV", False).__str__()[:7]}"
RPIFW_SRC_URI = "https://api.github.com/repos/raspberrypi/firmware/tarball/39a2813a75827b3a4d104a97e8f872df5d4f7e54;downloadfilename=raspberrypi-firmware-${SHORTREV}.tar.gz"
RPIFW_S = "${WORKDIR}/raspberrypi-firmware-${SHORTREV}"

SRC_URI = "${RPIFW_SRC_URI}"
SRC_URI[sha256sum] = "c384394407d68491e73d39dedba2b8a5226480ec8d0f43d744691c5040ff2379"
