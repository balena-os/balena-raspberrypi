...
SRC_URI = "git://github.com/UniPiTechnology/unipi-tools.git;protocol=https;nobranch=1"
...
# Corresonds to v1.2.44
SRCREV = "8eadfe0dd3098e8973738c20d61b453b390d0f7d"
...
FILES:${PN} += " \
    ${nonarch_base_libdir}/systemd/system/unipi-ttymxc2-rs485.target \
    ${nonarch_base_libdir}/systemd/system/unipispi.target \
    ${nonarch_base_libdir}/systemd/system/unipi-ttys0-rs485.target \
    /opt/unipi/data \
    /opt/unipi/tools \
"
SYSTEMD_PACKAGES = "${PN}"
